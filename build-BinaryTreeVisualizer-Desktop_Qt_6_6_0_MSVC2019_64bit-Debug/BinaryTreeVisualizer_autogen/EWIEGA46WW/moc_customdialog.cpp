...
#include "../../../BinaryTreeVisualizer/customdialog.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCustomDialogENDCLASS_t qt_meta_stringdata_CLASSCustomDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(13, 16),  // "intValueSelected"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 5),  // "value"
        QT_MOC_LITERAL(37, 15)   // "optionASelected"
    },
    "CustomDialog",
    "intValueSelected",
    "",
...
void CustomDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CustomDialog::*)(int , bool );
            if (_t _q_method = &CustomDialog::intValueSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomDialog::intValueSelected(int _t1, bool _t2)
{
