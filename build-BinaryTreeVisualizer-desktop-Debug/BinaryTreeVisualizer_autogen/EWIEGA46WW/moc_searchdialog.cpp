...
#include "../../../BinaryTreeVisualizer/searchdialog.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSearchDialogENDCLASS_t qt_meta_stringdata_CLASSSearchDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(13, 12),  // "searchResult"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 5),  // "found"
        QT_MOC_LITERAL(33, 19)   // "searchButtonClicked"
    },
    "SearchDialog",
    "searchResult",
    "",
...
void SearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->searchResult((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->searchButtonClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SearchDialog::*)(bool );
            if (_t _q_method = &SearchDialog::searchResult; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SearchDialog::searchResult(bool _t1)
{
